            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-info-single">
                        ...
                        <h5>Payment</h5>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia quod similique, voluptatum architecto rem natus? Minus explicabo iusto delectus est itaque a id hic. Mollitia sed totam quo. Eveniet, quis.
                    </div>
                </div>
            </div>
            <hr>
        ...
        <section class="copyright">
            <div class="container">
                <div class="row text-center">
                    <div class="col-sm-12">
                    <p>Copyright © 2017.  <a class="websitename" href="index.php">Show<b>Now</b></a> </p>
                    </div>
